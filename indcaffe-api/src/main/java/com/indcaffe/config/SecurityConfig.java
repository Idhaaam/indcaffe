        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> 
                    auth.requestMatchers("/api/auth/**").permitAll()
                        .requestMatchers("/", "/pages/**", "/js/**", "/css/**", "/assets/**", "/*.html", "/images/**", "/error", "/h2-console/**", "/uploads/**", "/api/upload/**").permitAll()
                        .requestMatchers("/api/admin/**", "/api/manager/**", "/api/gudang/**", "/api/warehouse/**").hasAuthority("ROLE_ADMIN")
                        .requestMatchers("/api/pelanggan/**").hasAuthority("ROLE_PELANGGAN")
                        .requestMatchers("/api/transactions/mitra/**").hasAuthority("ROLE_MITRA")
